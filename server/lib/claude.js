...
function buildSystemPrompt(profile) {
  ...
  // Rich life context from conversational intake
  let personalContext = ''
...
--- END CLIENT PROFILE ---`
  ...
  // User-trained memories — things they explicitly told the AI to remember
...
These are facts the client chose to feed you explicitly. Treat them as high-trust and ground your responses in them whenever they are relevant. When the current conversation touches these threads, reference them naturally.`
  }
...
module.exports = { buildSystemPrompt, createChatCompletion, openai }
